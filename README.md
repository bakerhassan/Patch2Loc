...
Official implementation of **[Patch2Loc: Learning to Localize Patches for Unsupervised Brain Lesion Detection](https://openreview.net/forum?id=F5nwzHc5Nv)** (AISTATS 2026).

Patch2Loc introduces a learning framework for **unsupervised detection and localization of brain lesions in MRI**.  
The method learns patch-level representations and leverages predictive uncertainty to identify abnormal tissue **without requiring voxel-level lesion annotations**.


![Patch2Loc pipeline](schematic.jpg)
...
## Data
*I followed @FinnBehrendt data pre-processing with some modifications as explained in the paper*. 

We use the IXI dataset, the BraTS21, MSLUB, ATLAS_v2 and WMH datasets for our experiments. 
You can download/request the datasets here:
...
## Acknowledgment
 I'd like to thank @FinnBehrendt for sharing his code. My data/test code is adopted from his contribution on GitHub. 
